...
namespace FakeXiecheng.API.Controllers
{
    ...
    public class TouristRoutePicturesController:ControllerBase
    {
        ...
        public IActionResult GetPictureListForTouristRoute(Guid touristRouteId) {
            ...
            var pictureFromRepoDto = _mapper.Map<IEnumerable<TouristRoutePictureDto>>(pictureFromRepo);
            return Ok(pictureFromRepoDto);
        }
        ...
        ) 
        {
            ...
            _touristRouteRepository.AddTouristRoutePicturre(touristRouteId,pictureModel);
